           ...
           <div class="row">
                ...
                :filter-key="searchQuery" :itemsPerPage=itemPerPage :display-names="displayNames">
                    ...
                    <template slot="action" slot-scope="props">
                           <button class="btn btn-secondary btn-circle" data-toggle="modal" data-target="#myModal" title="Role info"><i class="fa fa-info" @click="getRecord(props.entry.id)"></i></button>
